...
export default {
  ...
  */
  ...
  env: {
    ...
    BASE_API_URL: "http://18.140.51.167",
  ...
  */
  ...
  auth: {
    strategies: {
      local: {
        endpoints: {
          login: { url: `http://18.140.51.167/v1/login/email`, method: 'post', propertyName: 'token' },
          logout: false,
          user: { url: 'http://18.140.51.167/me', method: 'post', propertyName: 'data' }
        },
        tokenRequired: true,
        tokenType: 'Bearer'
      }
